...
/*/{Protheus.doc} F200DB2

O ponto de entrada F200DB2, utilizado no CNAB a receber, será executado
apos gravar as outras despesas bancarias no SE5.
...
User Function F200DB2
    ...
    //---------------------------------------------------------//
    //-- Envia outras despesas para conta corrente principal --//
    //---------------------------------------------------------//
